...
[![My Skills](https://skillicons.dev/icons?i=apollo,graphql,mcp,rust,bun,vite,astro,react,svelte,nestjs,prisma,postgres,redis,docker,cloudflare,aws,codepen,git,github,githubactions,html,css,js,ts,npm,py,django,java,spring)](https://skillicons.dev)
